...
extension DataService {
    ...
    func getAllColors(onCompletion: @escaping (_ colors: [UIColor]) -> ()) {
        ...
        REF_COLORS.observe(.value) { (dataSnapshot) in
...
extension DataService {
    ...
    var people: [Assignee] {
        return setupassignee()
    }
    
    func setupassignee() -> [Assignee] {
        ...
        let peoples = [assignee1, assignee2, assignee3, assignee4, assignee5, assignee6, assignee7]
        return peoples
    }
}
