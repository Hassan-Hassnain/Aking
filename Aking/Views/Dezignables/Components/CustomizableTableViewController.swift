//
//  CustomizableTableViewController.swift
//  Pods
//
...
class CustomizableTableViewController: UITableViewController, CustomizableSeparator, CustomizableHiddenSections, CustomizableHighlight, CustomizableStatusBar, CustomizableHiddenNavigationBar {
  ...
  override open func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    if let CustomizableCell = cell as? CustomizableTableViewCell {
      self.setupCell(CustomizableCell, forIndexPath: indexPath)
    }
    return cell
  }
  
  open func setupCell(_ cell: CustomizableTableViewCell, forIndexPath indexPath: IndexPath) {
