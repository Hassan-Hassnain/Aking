...
class CustomizableImageView: UIImageView, CustomizableBorder, CustomizableCorner, CustomizableRotation, CustomizableBackground, CustomizableShadow {
    ...
    @IBInspectable open var allBorders: Bool = false {
        didSet {
            self.setupBorder()
        }
    }
